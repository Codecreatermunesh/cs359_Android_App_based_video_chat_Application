...
import com.munesh.videoconferencingtool.adapter.UserRvAdapter
import com.munesh.videoconferencingtool.databinding.FragmentMainBinding
...
import com.munesh.videoconferencingtool.viewmodels.UserViewModel
...
class MainFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.newContactBtn.setOnClickListener {
            findNavController().navigate(com.munesh.videoconferencingtool.R.id.action_mainFragment_to_selectNewUserFragment)
        }
